...
boton0 = Button(ventana, text="0", width=16, height=2, command=lambda: boton_click(0))
...
boton_div = Button(ventana, text="/", width=5, height=2, command=lambda: boton_click("/"))
boton_mult = Button(ventana, text="x", width=5, height=2, command=lambda: boton_click("*"))
boton_sum = Button(ventana, text="+", width=5, height=2, command=lambda: boton_click("+"))
boton_rest = Button(ventana, text="-", width=5, height=2, command=lambda: boton_click("-"))
